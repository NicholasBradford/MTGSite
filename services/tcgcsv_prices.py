...
# Non-standard foiling / finish-specific TCGPlayer mapping helpers live in
# tcgcsv_finish_mapping.py now. These imports preserve older call sites that
# still import the functions from services.tcgcsv_prices.
try:
    from .finish_mapping import (
        SPECIAL_FINISHES,
        SUPPORTED_TCGCSV_FINISHES,
        PRICE_FIELD_ALIASES,
        AUTO_FINISH_OVERRIDE_NOTE_PREFIX,
        TCGCSV_LOCAL_PRODUCTS_CACHE,
        product_finish_from_name,
        subtype_matches_finish,
        find_finish_product_id_from_local_prices,
        get_inventory_special_finish_rows,
        search_tcgcsv_products_for_finish,
        preview_local_finish_product_mappings,
        auto_insert_finish_price_overrides,
        search_local_tcgcsv_price_candidates_for_finish,
        load_local_products_cache,
